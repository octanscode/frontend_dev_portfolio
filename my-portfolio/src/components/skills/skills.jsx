    ...
    <div className="pl-1 pr-3">
      <div className="grid grid-cols-4">
        ...
        <div className="col-span-3 grid grid-cols-3 gap-x-10 gap-y-10">
          ...
          <SkillModel name={"CSS3"} value={80} key={"CSS3"} />
          <SkillModel
            name={"Javascript (ES6+)"}
            value={90}
            key={"Javascript"}
          ...
          <SkillModel name={"React.js"} value={95} key={"React.js"} />
          <SkillModel name={"Next.js"} value={95} key={"Next.js"} />
          <SkillModel name={"Flux"} value={87} key={"Flux"} />
          ...
          <SkillModel name={"Git"} value={97} key={"Git"} />
